...
# 明确加载冻结底座，避免宿主程序已导入的同名 geometry 被误用。
_spec = importlib.util.spec_from_file_location("_cumcm_frozen_geometry", BASE / "geometry.py")
if _spec is None or _spec.loader is None:
    raise ImportError("无法加载 b_adaptive_q3/geometry.py")
