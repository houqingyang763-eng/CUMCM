...
def capture_sources():
    names = ("task_cost.py", "sweep_policy.py", "q4.py", "q4run.py", "q4_compare.py", "q4_anchor_design.py", "q4_coverage.py",
             "q4_joint_state.py", "q2_geometry.py", "coverage.py", "astra_guard.py")
    paths = [*ROOT.glob("*.py"), *ROOT.glob("*.ps1"), *(NIGHT / name for name in names),
