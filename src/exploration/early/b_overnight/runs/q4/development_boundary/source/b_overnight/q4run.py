...
def run_case(scene, policy_name, trace_path=None, config=None):
    check_cached()
    ...
    policy, state, env = factory(policy_name)(config or Q4Config()), Q4InformationState(), LocalEnvironment(scene)
    rows, error = [], None
