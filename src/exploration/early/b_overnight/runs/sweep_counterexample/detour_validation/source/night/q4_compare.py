...
from q4_anchor_design import Q4ReducedAnchorPolicy, Q4Symmetric25Policy
...
def factories(name):
    ...
    if name == "anchors25":
        return Q4Symmetric25Policy, Q4CoverageInformationState, Q4Config()
    if name == "joint25":
        return Q4Symmetric25Policy, Q4JointCoverageInformationState, Q4Config()
    if name == "sweep25":
        from sweep_policy import Q4SweepPolicy
        return Q4SweepPolicy, Q4JointCoverageInformationState, Q4Config()
