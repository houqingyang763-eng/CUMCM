...
25点策略的三个定义直接移植自 b_overnight/q4_anchor_design.py。
test_runner 对这些定义作 AST 等价检查；改动只限独立导入环境。
"""
...
def bootstrap():
    for folder in (PROJECT / "experiments" / "b_adaptive_q3",
                   PROJECT / "experiments" / "b_oracle_q3",
                   PROJECT / "experiments" / "b_overnight"):
